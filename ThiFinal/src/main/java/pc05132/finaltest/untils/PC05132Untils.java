package pc05132.finaltest.untils;
...
@WebListener
public class PC05132Untils implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		emf = Persistence.createEntityManagerFactory("ThiFinal");
	}
	...
	public static <T> List<T> excuteQuey(String jpaql, Class<T> myClass) {
		...
		try (EntityManager em = PC05132Untils.getFactory().createEntityManager()) {
