...
// test làm mới form-----------------------------------------------------------------------------------------
	...
	public void lamMoiTest(String txtPXK, String txtDienGiai, String txtGiaXuat, String txtsoKhung, String expected) {
		String actualy = "";
		if (txtPXK.isEmpty() && txtDienGiai.isEmpty() && txtGiaXuat.isEmpty() && txtPXK.isEmpty()
				&& txtsoKhung.isEmpty()) {
	...
	public void xoaPhieuXuat(boolean isManager, String txtSoKhung, String txtPXK, String txtgiaXuat, boolean confirm,
			String expected) {
...
//List<ChiTietPhieuNhap> listPX = ChiTietPhieuNhapDAO.getNewChiTietPhieuNhapDAO().selectAll_MaPhieuNhap(txtPXK);
		String ListPXK = "PX2023072200001";
		String actualy = "";
		if (txtPXK.equals(ListPXK)) {
			if (confirm) {
...
//             
					...
					actualy = "Có lỗi. Vui lòng kiểm tra lại thông tin!";
				}
			} else {
				actualy = "Bạn không xác nhận xóa";
			}
		} else {
			actualy = "Thông báo phiếu xuất chưa có trong cơ sở dữ liệu. Vui lòng chọn phiếu xuất khác";
		}
	...
	private Object[][] xoaPXKProvider() {
		return new Object[][] {
				{ false, "SK001", "PX20230722000011", "1234", true,
						"Thông báo phiếu xuất chưa có trong cơ sở dữ liệu. Vui lòng chọn phiếu xuất khác" },
				{ false, "SK001", "PX2023072200001", "1234", false, "Bạn không xác nhận xóa" },
				{ true, "SK001", "PX2023072200001", "1234", true, "Bạn không có quyền xóa phiếu nhập" },
				{ false, "", "PX20230722000011", "", true, "Có lỗi. Vui lòng kiểm tra lại thông tin!" },
				{ false, "SK001", "PX2023072200001", "1234", true, "Xóa thành công" } };
