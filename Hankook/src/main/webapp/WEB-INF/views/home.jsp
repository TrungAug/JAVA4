...
<body class="d-flex flex-column justify-content-between" style="height: 100vh;">
    <div class="container-fluid">
       <header>
        ...
        <main class="main">
            <div id="sliderCarouse" class="carousel slide mb-3" data-bs-ride="carousel">
                <div class="carousel-indicators">
                    <button type="button" data-bs-target="#sliderCarouse" data-bs-slide-to="0" class="active"
                        aria-current="true" aria-label="Slide 1"></button>
                    <button type="button" data-bs-target="#sliderCarouse" data-bs-slide-to="1"
                        aria-label="Slide 2"></button>
                    <button type="button" data-bs-target="#sliderCarouse" data-bs-slide-to="2"
                ...
                <button class="carousel-control-prev" type="button" data-bs-target="#sliderCarouse"
                    data-bs-slide="prev">
                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                    <span class="visually-hidden">Previous</span>
                </button>
                <button class="carousel-control-next" type="button" data-bs-target="#sliderCarouse"
                    data-bs-slide="next">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12 mb-3">
                                <div class="card d-flex flex-column h-100">
                                    <a href="/templates/productdetail.html">
            ...
            <div class="row m-5 subscribe-now d-flex flex-column justify-content-center text-center">
                <div class="col mb-4">
                    <h1>Subscribe Now</h1>
                </div>
                <div class="col mb-4">
                    <h4>
                        Receive the latest news from Hankook Tire & Technology
                    </h4>
                </div>
                <div class="col mb-4 d-flex justify-content-center">
                    <div class="input-group mb-3 position-relative w-50">
                        ...
                        <div class="icon-accepted-inform position-absolute top-50 translate-middle-y end-0">
                            <a href="#">
            ...
            <div class="row m-5 post-introduce-hankook">
                ...
                <div id="sliderCarousePost" class="carousel slide mb-3" data-bs-ride="carousel">
                    <div class="carousel-indicators">
                        <button type="button" data-bs-target="#sliderCarousePost" data-bs-slide-to="0" class="active"
                            aria-current="true" aria-label="Slide 1"></button>
                        <button type="button" data-bs-target="#sliderCarousePost" data-bs-slide-to="1"
                            aria-label="Slide 2"></button>
                        <button type="button" data-bs-target="#sliderCarousePost" data-bs-slide-to="2"
                            aria-label="Slide 3"></button>
                    </div>
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="3000">
                            <div class="row prods-post mt-3">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="box-img mb-3">
                                                <img src="https://asset.hankooktire.com/content/dam/hankooktire/au/main/press-release/news_home_20231108_2.jpg"
                                                    class="img-thumbnail w-100" alt="...">
                                            </div>
                                            <div class="card-text mb-3" style="color: #999;">
                                                Type của post
                                            </div>
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="box-img mb-3">
                                                <img src="https://asset.hankooktire.com/content/dam/hankooktire/au/main/press-release/news_home_2022_0816.jpg"
                                                    class="img-thumbnail w-100" alt="...">
                                            </div>
                                            <div class="card-text mb-3" style="color: #999;">
                                                Type của post
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#sliderCarousePost"
                        data-bs-slide="prev">
                        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Previous</span>
                    </button>
                    <button class="carousel-control-next" type="button" data-bs-target="#sliderCarousePost"
                        data-bs-slide="next">
                        <span class="carousel-control-next-icon" aria-hidden="true"></span>
                        <span class="visually-hidden">Next</span>
                    </button>
