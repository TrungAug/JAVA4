										...
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												...
												<input type="text" id="editProfileFullname"
													name="editProfileInputFullname" class="form-control"
													required>
											</div>
										</div>
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												...
												<input type="text" id="editProfileUsername"
													name="editProfileInputUsername" class="form-control"
													required>
											</div>
										</div>
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline mb-4">
												<label class="form-label" for="editProfileEmail">Email
													...
													class="form-control" name="editProfileInputEmail" required>
											</div>
										</div>
										<div class="col-md-6 mb-4">
											<div class="form-outline mb-4">
