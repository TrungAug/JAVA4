		...
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title text-info"
					id="editorEditSizeProductModalLabel">Sửa Size Sản Phẩm</h5>
				<button type="button" class="btn-close" data-bs-dismiss="modal"
					aria-label="Close"></button>
			</div>
			<div class="modal-body row d-flex justify-content-center">
				<c:url var="url" value="/admin"></c:url>
				<form action="${url}/edit-size-product" method="post">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
							<div class="input-group mb-5">
								<span class="input-group-text"
									...
									type="text" class="form-control"
									aria-label="Sizing example input"
									aria-describedby="editorPage-addSizeForm-size-id" value="${showP.idPro}" name="sizeName">
							</div>
						</div>
						<div class="col-md-6 col-sm-12">
							<div class="input-group mb-5">
