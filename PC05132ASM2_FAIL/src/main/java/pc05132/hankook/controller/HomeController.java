...
public class HomeController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String idTyre = req.getParameter("idTyres");
		req.getSession().setAttribute("idTyre", idTyre);
		if(idTyre!=null) {
			String idPram = req.getParameter("idTyre");
			try(EntityManager em = HankookUntils.getFactory().createEntityManager()){
				StoredProcedureQuery query = em.createStoredProcedureQuery("spFilterByTyre");
				query.setParameter("idTyreParam",idPram);
