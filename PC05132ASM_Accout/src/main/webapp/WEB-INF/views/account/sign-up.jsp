							...
							<div class="card-body p-5 text-center">
								...
								<form action="sign-up" method="post">
									<div class="row">
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												<label class="form-label" for="registerModalName">UsernameID</label>
												<input type="text" id="registerModalName" name="id"
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline mb-4">
												<label class="form-label" for="registerModalEmail">Email
													...
													class="form-control" name="emailAdd" required>
											</div>
										</div>
										<div class="col-md-6 mb-4">
											<div class="form-outline mb-4">
									...
									<div class="form-check d-flex justify-content-center mb-4">
										<input class="form-check-input me-2" type="hidden" value="false"
											id="registerModalPassCheckBox" name="isAdmin"/> <label
