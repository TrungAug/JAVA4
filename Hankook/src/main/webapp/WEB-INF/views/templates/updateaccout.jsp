                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                ...
                                                <input type="text" id="editProfileFullname"
                                                    name="editProfileInputFullname" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline">
                                                ...
                                                <input type="text" id="editProfileUsername"
                                                    name="editProfileInputUsername" class="form-control" required>
                                            </div>
                                        </div>
                                       
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="editProfileEmail">Email Address</label>
                                                <input type="email" id="editProfileEmail" class="form-control"
                                                    name="editProfileInputEmail" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-4">
                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="editProfilePass">Password</label>
                                                <input type="password" id="editProfilePass" minlength="8"
                                                    class="form-control" name="editProfileInputPass" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="date" id="editProfileDate" class="form-control"
                                            name="editProfileInputBirthday" required>
                                    </div>
                                    <button type="button" class="btn btn-primary btn-block mb-4" id="editProfileButton">
                                        Update
                                    </button>
                                </form>
                            </div>
